...
export default function Vitals( {jessicaData} ) {
    ...
    const data = [
        ...
        { title: "heart beat", reading: jessicaData[0].heart_rate.value, interpretation :  jessicaData[0].heart_rate.levels, bgColor: "bg-rer-10d-100", icon: heart }
    ]

    return <div className="flex h-full items-center justify-center flex-4 gap-4 h-full ">
